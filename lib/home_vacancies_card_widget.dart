...
import 'package:kitob_ol/home_vacancies_card_detail.dart';
import 'package:kitob_ol/text_style.dart';
import 'package:kitob_ol/widget/text_class.dart';

class HomeVacanciesCardWidget extends StatelessWidget {
  final Ish ish;
  const HomeVacanciesCardWidget({
    super.key,
    required this.ish,
  });
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => HomeVacanciesCardDetail(vacancies: ish)));
      },
      child: Container(
